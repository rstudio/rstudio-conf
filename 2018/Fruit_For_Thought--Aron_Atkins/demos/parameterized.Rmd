...
output: 
  html_document:
    css: pomological.css
params:
  # Select one of the ten most common fruits.
  fruit:
    value: any
    choices:
      - any
      ...
      - grapefruits
      - avocados
  # Case insensitive search for variety.
  variety:
    label: variety (empty is ok)
    value: ""
  # Filter year by upper/lower-bound.
  year:
    input: slider
    min: 1886
    max: 1942
...
fruitName <- params$fruit
varietyName <- params$variety
