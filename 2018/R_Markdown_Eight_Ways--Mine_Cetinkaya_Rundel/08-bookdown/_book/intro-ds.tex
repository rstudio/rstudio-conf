...
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{(state }\OperatorTok{%in%}\StringTok{ }\NormalTok{states}\OperatorTok{$}\NormalTok{abbreviation))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    state }\OperatorTok{%in%}\StringTok{ }\NormalTok{state.abb     }\OperatorTok{~}\StringTok{ "United States"}\NormalTok{,}
\NormalTok{    state }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"ON"}\NormalTok{, }\StringTok{"BC"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Canada"}\NormalTok{,}
...
\includegraphics{intro-ds_files/figure-latex/unnamed-chunk-15-1.pdf}
