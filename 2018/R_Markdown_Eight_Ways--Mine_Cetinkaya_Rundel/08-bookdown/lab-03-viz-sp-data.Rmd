# Lab 3 - Visualizing spatial data
...
See [here](http://ggplot2.tidyverse.org/reference/labs.html) for help with the syntax for customizing your plots. You can also choose different themes to change the overall look of your plots, see [here](http://ggplot2.tidyverse.org/reference/ggtheme.html) for help with these.
